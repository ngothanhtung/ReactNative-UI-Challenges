  ...
  return (
    ...
    >
      <LinearGradient colors={GRADIENT_COLORS} style={{ flex: 1 }}>
        ...
        <View style={{ height: 280, alignItems: 'center', justifyContent: 'flex-end' }}>
          <View style={{ height: 160, width: 160, backgroundColor: '#ffffff', justifyContent: 'center', alignItems: 'center', borderRadius: 80, borderWidth: 16, borderColor: LIGHT_COLOR }}>
            <FontAwesome5Icon name='spa' size={75} style={{ color: MAIN_COLOR }} />
          </View>
        </View>

        <View style={{ flex: 1, justifyContent: 'flex-start', padding: 24 }}>
          <View style={{ borderBottomColor: PLACEHOLDER_TEXT_COLOR, borderBottomWidth: 1.5, marginVertical: 8, flexDirection: 'row', alignItems: 'center' }}>
            <FontAwesome5Icon name='id-card-alt' size={20} style={{ paddingRight: 16 }} color={ICON_COLOR} />
            <TextInput placeholder='Username' placeholderTextColor={PLACEHOLDER_TEXT_COLOR} style={{ fontSize: 18, fontWeight: '700' }} />
          </View>
          <View style={{ borderBottomColor: PLACEHOLDER_TEXT_COLOR, borderBottomWidth: 1.5, marginVertical: 8, flexDirection: 'row', alignItems: 'center' }}>
            <FontAwesome5Icon name='user-alt' size={20} style={{ paddingRight: 16 }} color={ICON_COLOR} />
            <TextInput placeholder='Full Name' placeholderTextColor={PLACEHOLDER_TEXT_COLOR} style={{ fontSize: 18, fontWeight: '700' }} />
          </View>
          <View style={{ borderBottomColor: PLACEHOLDER_TEXT_COLOR, borderBottomWidth: 1.5, marginVertical: 8, flexDirection: 'row', alignItems: 'center' }}>
            <FontAwesome5Icon name='phone' size={20} style={{ paddingRight: 16 }} color={ICON_COLOR} />
            <TextInput placeholder='Phone' placeholderTextColor={PLACEHOLDER_TEXT_COLOR} style={{ fontSize: 18, fontWeight: '700' }} />
          </View>
          <View style={{ borderBottomColor: PLACEHOLDER_TEXT_COLOR, borderBottomWidth: 1.5, marginVertical: 8, flexDirection: 'row', alignItems: 'center' }}>
            <FontAwesome5Icon name='lock' size={20} style={{ paddingRight: 16 }} color={ICON_COLOR} />
            <TextInput placeholder='Password' placeholderTextColor={PLACEHOLDER_TEXT_COLOR} style={{ fontSize: 18, fontWeight: '700' }} />
          </View>
          <TouchableOpacity style={{ marginVertical: 32, height: 54, backgroundColor: MAIN_COLOR, borderRadius: 8, justifyContent: 'center', alignItems: 'center' }}>
